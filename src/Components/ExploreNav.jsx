...
export default function ExploreNav() {
  return (
    <nav className="w-full bg-black px-4 py-3 flex items-center justify-between">
      ...
      <div className="flex items-center gap-2 sm:gap-6 text-white text-sm sm:text-base md:text-lg font-mono cursor-pointer">
        <a href="/" className="hover:text-black hover:bg-white transition-colors duration-300 p-2 rounded">
          Home
        </a>
        <a href="#" className="hover:text-black hover:bg-white transition-colors duration-300 p-2 rounded">
          Algorithms
        ...
        {/* Dark Mode Button */}
        <button className="text-white text-2xl sm:text-3xl flex-shrink-0 ml-auto">
