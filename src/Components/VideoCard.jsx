...
export default function VideoCard({ title }) {
  ...
  const handleClick = () => {
    navigate("/main"); // redirects from '/' to '/main'
  };
  return (
    <div className="w-[348px] h-[290.25px] border-black border-[0.75px] rounded-[18.75px] flex flex-col justify-between overflow-hidden" onClick={handleClick}>
      
      {/* Video Section */}
       <div className="bg-black w-[283.5px] h-[172.5px] mx-auto mt-4 border-black border-[0.75px] rounded-[18.75px] flex items-center justify-center">
